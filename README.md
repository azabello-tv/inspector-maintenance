...
|dates|Даты, по которым применяется правило. После даты, через слэш (/) можно указать часы, тогда правило будет применятся в эту дату в эти часы. Если часы не указаны, дата расчитывается **с учетом сессии символа**. Т.е. для овернайт символов, достаточно указать дату торгового дня - например, запись "2018-01-20" для сессии "1700-1700" (форекс) начнет примется 2018-01-19 в 17:00 и закончит 2018-01-20 в 17:00. Расчитываются в таймзоне биржи|
